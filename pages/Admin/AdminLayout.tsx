...
const AdminLayout: React.FC = () => {
  ...
  // Sidebar starts open on desktop but can be closed
  ...
  return (
    <div className="flex min-h-screen bg-[#FCFCFA] text-black overflow-x-hidden">
      {/* Universal Top Navigation Bar for mobile and as toggle trigger */}
      ...
      {/* Sidebar - Now toggleable on all screens */}
      <aside className={`
      ...
      {/* Scrim Overlay (Always used when sidebar is open on smaller screens, optional on LG) */}
      {sidebarOpen && (
        <div 
      ...
      {/* Main Orchestrator - Responsive Margin */}
